    ...
    <div class="es-dialog__body">
      ...
      >
        <img
          ...
          :src="exportTypeValue === item ? getImage.radioCheckTrue : getImage.radioCheckFalse"
        />
        <span class="export-type-text">{{ item === 'png' ? '透明底png' : '白色底jpg' }}</span>
      </div>
    </div>
...
import RadioFalse from '@/assets/img/i-Report-radio-false.png'
import RadioTrue from '@/assets/img/i-Report-radio-true.png'
export default {
  props: {
    visible: {
      type: Boolean,
