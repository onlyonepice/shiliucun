  ...
  <div :class="[ns.b(), 'es-commonPage']">
    <div :class="ns.b('main')">
      ...
      <div :class="ns.b('paging')">
        ...
        <el-pagination v-model:current-page="currentPage1" :page-size="10" :background="background"
          layout="prev, pager, next" :total="industryTotal" @current-change="handleCurrentChange" />
      </div>
    </div>
  </div>
</template>
