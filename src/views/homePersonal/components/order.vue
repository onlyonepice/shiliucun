<template>
  <div :class="[ns.b()]">
    <div :class="[ns.b('top')]">
      <h3>我的订单</h3>
      <el-button type="primary" :class="ns.be('top','button')" @click='onInvoicing()'>我要开票</el-button>
    </div>
    <el-table class="animate__animated animate__fadeIn" v-loading="loading" :data="tableData" style="width: 100%" header-row-class-name="table-class">
  ...
  <Dialog title="我要开票" :visible="invoicingVisible" :showFoot="false" width="560px" height="420px" @onHandleClose='onHandleClose' >
    <template #content>
