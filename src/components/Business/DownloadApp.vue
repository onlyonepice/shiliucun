<template>
    ...
    >
      <div class="pay_game">
        <div class="platform"><img :src="ios"> iOS <img class="code" :src="base?.ios_download"/></div>
        <div class="platform"><img :src="Android">安卓<img class="code" :src="base?.android_download"/></div>
      </div>
    </el-dialog>
  </template>
