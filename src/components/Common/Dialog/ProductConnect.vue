<template>
  <el-dialog
    ...
    style="padding: 0"
  >
    <img :src="ProductConnect" :class="ns.b('img')" />
...
import ProductConnect from "@/assets/img/common/product-connect.png";
const ns = useNamespace("productConnect");
...
.es-productConnect-img {
  @include widthAndHeight(100%, 100%);
}
.es-productConnect-empty {
