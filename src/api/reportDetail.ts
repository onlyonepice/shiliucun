...
export const setReportCollect_V2 = ( url, { collectionType, reportId, uncollect } ) => {
  return http.request<void>("post", url, {
    data: {
      collectionType,
      reportId,
...
export const setReportScore_V2 = ({ level, moduleName, reportId, score }) => {
  return http.request<void>("post", `/eesa-report/onlineReportNewScore/front/v1.0/reportScoring`, {
    data: {
      level,
      moduleName,
      reportId,
...
export const setReportFeedback_V2 = ({
  ...
  return http.request<void>("post", `/eesa-report/onlineReportNewError/front/v1.0/addContentCorrection`, {
    data: {
      name,
      contactInformation,
      describe,
...
export function getPayInfoList() {
  return http.request<void>("post", '/eesa-report/product/product/front/v1.0/clientList', {
  });
}
